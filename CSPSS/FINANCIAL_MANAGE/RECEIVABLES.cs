    ...
    public partial class RECEIVABLES : Form
    {
        ...
        public void search_o(string sql)
        {
            ...
            else*/ if (v7 == "Y")
            {
                ...
                dt = bc.getdt(sql+" ORDER BY 应收单号 ASC");
 ...
 (SELECT UGID FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" );
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1["应收日期", i].Value = dt.Rows[i]["应收日期"].ToString();
                    ...
                    dataGridView1["数量", i].Value = dt.Rows[i]["实际销货数量"].ToString();
                    ...
                    DataTable dtx1 = bc.GET_DT_TO_DV_TO_DT(dtt, "", "应收单号='"+dt.Rows[i]["应收单号"].ToString()+"'");
                    ...
                    else
                    {
                        ...
                        dr["应收单号"] = dt.Rows[i]["应收单号"].ToString();
                        dtt.Rows.Add(dr);
                        j = j + decimal.Parse(dt.Rows[i]["实际应收金额"].ToString());
                    }
                }
        ...
        {
            CSPSS.FINANCIAL_MANAGE.RECEIVABLEST FRM = new FINANCIAL_MANAGE.RECEIVABLEST(this);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                RECEIVABLEST FRM = new RECEIVABLEST(this);
                string v1 = dt.Rows[dataGridView1.CurrentCell.RowIndex]["应收单号"].ToString();
                FRM.IDO = v1;
