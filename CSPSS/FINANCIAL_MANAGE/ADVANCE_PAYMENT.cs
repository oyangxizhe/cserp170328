...
{
    public partial class ADVANCE_PAYMENT : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ADVANCE_PAYMENT));
        ...
        public void bind()
        {
            ...
            d3.Name = "金额";
            d3.HeaderText = "预付小计/Sum";
            dataGridView1.Columns.Add(d3);

            DataGridViewTextBoxColumn d4 = new DataGridViewTextBoxColumn();
            d4.Name = "总计";
            d4.HeaderText = "预付总计/Total";
            dataGridView1.Columns.Add(d4);
            dataGridView1.Rows.Clear();
            hint.Text = "";
            StringBuilder stb = new StringBuilder();
            stb.Append(cADVANCE_PAYMENT.sql);
            stb.Append("  WHERE B.PICKID LIKE '%" + textBox1.Text + "%'");
            stb.Append("  AND F.UNAME LIKE '%" + textBox3.Text + "%'");
        ...
        public void search_o(string sql)
        {
            ...
            else*/ if (v7 == "Y")
            {
                ...
                dt = bc.getdt(sql+" ORDER BY A.APID ASC");
 ...
 (SELECT UGID FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" );
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        dr["预付单号"] = dt.Rows[i]["预付单号"].ToString();
                        dtt.Rows.Add(dr);
                        j = j + decimal.Parse(dt.Rows[i]["预付金额"].ToString());
                    }
                }
        ...
        private void dgvStateControl()
        {
            ...
            this.dataGridView1.MergeColumnNames.Add("金额");
        ...
        {
            CSPSS.FINANCIAL_MANAGE.ADVANCE_PAYMENTT FRM = new FINANCIAL_MANAGE.ADVANCE_PAYMENTT(this);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ADVANCE_PAYMENTT FRM = new ADVANCE_PAYMENTT(this);
                string v1 = dt.Rows[dataGridView1.CurrentCell.RowIndex]["预付单号"].ToString();
                FRM.IDO = v1;
                FRM.MGID = bc.getOnlyString("SELECT MGID FROM ADVANCE_PAYMENT WHERE APID='"+v1+"'");
                FRM.PICKID = dt.Rows[dataGridView1.CurrentCell.RowIndex]["提货单号"].ToString();
