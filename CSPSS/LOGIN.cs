...
namespace CSPSS
{
    public partial class LOGIN : Form
    {
        ...
        private void LOGIN_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "xxx International Co. Managing System";
               ...
               if (cuser.JUAGE_LOGIN_IF_SUCCESS(comboBox1 .Text ,textBox1 .Text ))
                {
                    ...
                    DEPART = bc.getOnlyString("SELECT DEPART FROM USERINFO WHERE UNAME='"+comboBox1 .Text +"'");
        ...
        private bool juage()
        {
            ...
            SQLCONNECTIONSTRING = bc.GET_SQLCONNECTION_STRING();
