...
{
    public partial class PAYMENT_ORDER : Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PAYMENT_ORDER));
        ...
        public void bind()
        {
            ...
            d7.Name = "供应商ID";
            d7.HeaderText = "供应商ID/Supplier ID";
        ...
        public void search_o(string sql)
        {
            ...
            else*/ if (v7 == "Y")
            {
                ...
                dt = bc.getdt(sql+" ORDER BY 付款单号 ASC");
 ...
 (SELECT UGID FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" );
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1["付款日期", i].Value = dt.Rows[i]["付款日期"].ToString();
                    dataGridView1["供应商ID", i].Value = dt.Rows[i]["供应商ID"].ToString();
                    dataGridView1["付款方式", i].Value = dt.Rows[i]["付款方式"].ToString();
                    dataGridView1["入库日期", i].Value = dt.Rows[i]["入库日期"].ToString();
                    dataGridView1["金额", i].Value = dt.Rows[i]["金额"].ToString();
                
                    DataTable dtx1 = bc.GET_DT_TO_DV_TO_DT(dtt, "", "付款单号='"+dt.Rows[i]["付款单号"].ToString()+"'");
                    ...
                    else
                    {
                        ...
                        dr["付款单号"] = dt.Rows[i]["付款单号"].ToString();
                        dtt.Rows.Add(dr);
        ...
        {
            int i;
            this.dataGridView1.MergeColumnNames.Add("付款日期");
        ...
        {
            CSPSS.FINANCIAL_MANAGE.PAYMENT_ORDERT FRM = new FINANCIAL_MANAGE.PAYMENT_ORDERT(this);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                PAYMENT_ORDERT FRM = new PAYMENT_ORDERT(this);
                string v1 = dt.Rows[dataGridView1.CurrentCell.RowIndex]["付款单号"].ToString();
                FRM.IDO = v1;
                FRM.MGID = dt.Rows[dataGridView1.CurrentCell.RowIndex]["入库单号"].ToString();
