    ...
    public partial class SELLTABLE : Form
    {
        ...
        public void bind()
        {
            ...
            try
            {
                ...
                {
                    stb.Append(" AND 日期  BETWEEN  '" + v1 + "' AND '" + v2 + "'");
        ...
        public void search_o(string sql)
        {
            ...
            else*/ if (v7 == "Y")
            {
                ...
                dt = bc.getdt(sql+" ORDER BY 销货单号 ASC");
 ...
 (SELECT UGID FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" );
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dataGridView1["销货日期", i].Value = dt.Rows[i]["销货日期"].ToString();
        ...
        {
            int i;
            this.dataGridView1.MergeColumnNames.Add("销货日期");
            this.dataGridView1.MergeColumnNames.Add("客户名称");
            this.dataGridView1.MergeColumnNames.Add("订单销货金额");
